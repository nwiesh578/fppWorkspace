...
public class Main {
	...
	public static void main(String[] args) {
		...
		double salarySum = Statistics.computeSumOfSalaries(combined); //directly we access the method with classname.method because the method is static, else we had to create and object of statistics to call the method.
		System.out.println("The total salary : "+salarySum);
		
	}
	
	//IMPLEMENT
	public static List<EmployeeData> combine(List<Staff> staff, List<Teacher> teachers) {
		List<EmployeeData> clist = new ArrayList();
		clist.addAll(staff);
		clist.addAll(teachers);
		return clist;
	}
